 ...
 * Class MySQLDatabase.
 *
 * This class represents a MySQLDatabase in the system. It implements the DataObjectRelationalMappingInterface.
 ...
 */
class MySQLDatabase implements DataObjectRelationalMappingInterface
{
    /**
